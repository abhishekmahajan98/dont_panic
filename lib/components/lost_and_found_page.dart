      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            _buildTFNumber("Age", (value) {
            setState(() {
              age = value;
            });
          },),
            _buildTFNumber("Appx Height", (value) {
            setState(() {
              appxHeight = value;
            });
          },),
            _buildTF("birthmark", (value) {
                setState(() {
                  birthMark = value;
                });
              },),
            _buildTF("place of lost",  (value) {
            setState(() {
              placeOfLost = value;
            });
          },),
            _buildTFNumber("Phone Number",(value) {
            setState(() {
              phoneNumber = value;
            });
          },),
            _buildTF("Complexion",(value) {
            setState(() {
              complexion = value;
            });
          },),
            _buildTF("Hair Colour", (value) {
            setState(() {
              hairColour = value;
            });
          },),
